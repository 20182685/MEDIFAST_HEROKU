...
const AttentionFrame = (props) => {

    const [seleccion, setSeleccion] = useState('ordenar');
    const [AttentionListVisible, setAttentionListVisible] = useState(false);

    useEffect(() => {
        seleccion === 'ordenar' ? setAttentionListVisible(true) : setAttentionListVisible(false);
    }, [seleccion]);
    ...
    return (
        <div className='layout-specing'>
            ...
            <div>
                {AttentionListVisible && <AttentionList props={props} />}
            </div>
